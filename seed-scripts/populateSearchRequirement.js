...
const searchRequirements = cities.map((city) => {
  ...
  const maxBudget = minBudget ? prices[Math.floor(Math.random() * 11)] : prices[Math.floor(Math.random() * 10)+1]

  const minnofbedrooms = bedrooms[Math.floor(Math.random() * 11)];
  const maxnofbedrooms = minnofbedrooms ? bedrooms[Math.floor(Math.random() * 11)] : bedrooms[Math.floor(Math.random() * 10)+1]

  const minnofbathrooms = bedrooms[Math.floor(Math.random() * 11)];
  const maxnofbathrooms = minnofbathrooms ? bedrooms[Math.floor(Math.random() * 11)] : bedrooms[Math.floor(Math.random() * 10)+1];
  ...
  return {
    ...
    minBudget: minBudget,
    maxBudget: maxBudget,
    minnofbedrooms: minnofbedrooms,
    maxnofbedrooms: minnofbedrooms,
    minnofbathrooms: minnofbedrooms,
    maxnofbathrooms: minnofbedrooms
  }
});
...
SearchRequirement.bulkCreate(searchRequirements.slice(100000, searchRequirements.length), { returning: true });
